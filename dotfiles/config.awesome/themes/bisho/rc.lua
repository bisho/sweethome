...
-- {{{ Main
theme = {}
theme.themedir = awful.util.getdir("config") .. "/themes/bisho"
-- }}}
...
-- {{{ Styles
--theme.font      = "ProggyTinyTT 12"
--theme.font      = "V5 Myopia 7"
...
-- {{{ Widget icons
theme.widget_network = theme.themedir .. "/icons/network.png"
