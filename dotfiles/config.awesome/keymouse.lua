...
globalkeys = awful.util.table.join(
	...
	function ()
		if client.focus then
			...
			i = awful.tag.getidx()
			if tags[screen][i-1] then
				awful.client.movetotag(tags[screen][i-1])
			end
		end
		awful.tag.viewprev()
	end),
...
clientbuttons = awful.util.table.join(
	...
	function(c)
--		io.stderr:write("Custom opacity increase " .. c.opacity .. " -> ")
		c.opacity=math.min(1, c.opacity*1.1)
--		io.stderr:write("" .. c.opacity .. "\n")
--		awful.util.spawn("transset-df --actual --inc 0.1")
	end),
    awful.button({ modkey }, 5,
	function(c)
--		io.stderr:write("Custom opacity decrease  " .. c.opacity .. " -> ")
		c.opacity=math.max(.2, c.opacity*.9)
--		io.stderr:write("" .. c.opacity .. "\n")
